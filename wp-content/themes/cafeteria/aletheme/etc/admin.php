...
function ale_add_admin_menu() {
    ...
    add_theme_page(__('Sliders Options', 'aletheme'), __('Sliders Options', 'aletheme'), 'edit_theme_options', 'aletheme_sliders','aletheme_sliders_page');
    ...
    add_theme_page(__('Online Docs', 'aletheme'), __('Online Docs', 'aletheme'), 'edit_theme_options', 'onlinedocs','aletheme_online_docs');
}
