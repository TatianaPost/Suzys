...
function aletheme_get_options() {
    ...
    $options[] = array( "name" => "Desserts pages Header image",
                        "desc" => "Upload the image. Recommended size 1900px-1145px",
                        "id" => "ale_dessertsheader",
                        "std" => "",
                        "type" => "upload");
    
    $options[] = array( "name" => "Where Can I Buy pages Header image",
                        "desc" => "Upload the image. Recommended size 1900px-1145px",
                        "id" => "ale_whereheader",
                        "std" => "",
                        "type" => "upload");

    $options[] = array( "name" => "Our Story pages Header image",
                        "desc" => "Upload the image. Recommended size 1900px-1145px",
                        "id" => "ale_ourstoryheader",
                        "std" => "",
                        "type" => "upload");

    $options[] = array( "name" => "News pages Header image",
                        "desc" => "Upload the image. Recommended size 1900px-1145px",
                        "id" => "ale_newsheader",
                        "std" => "",
                        "type" => "upload");

    $options[] = array( "name" => "Wholesale pages Header image",
                        "desc" => "Upload the image. Recommended size 1900px-1145px",
                        "id" => "ale_wholesaleheader",
                        "std" => "",
                        "type" => "upload");

    $options[] = array( "name" => "Blog pages Header image",
                        "desc" => "Upload the image. Recommended size 1900px-1145px",
                        "id" => "ale_blogheader",
                        "std" => "",
                        "type" => "upload");

    $options[] = array( "name" => "Customer Service pages Header image",
                        "desc" => "Upload the image. Recommended size 1900px-1145px",
                        "id" => "ale_customerserviceheader",
                        "std" => "",
                        "type" => "upload");

    $options[] = array( "name" => "Contact Us pages Header image",
                        "desc" => "Upload the image. Recommended size 1900px-1145px",
                        "id" => "ale_contactusheader",
                        "std" => "",
                        "type" => "upload");

    $options[] = array( "name" => "Dock and Delivery pages Header image",
                        "desc" => "Upload the image. Recommended size 1900px-1145px",
                        "id" => "ale_dockdeliveryheader",
                        "std" => "",
                        "type" => "upload");
