...
<?php
    ...
    if(ale_get_option('headerfont')){ echo "<link href='//fonts.googleapis.com/css?family=".ale_get_option('headerfont').$headerfontex."|".ale_get_option('mainfont').$mainfontex."|".ale_get_option('thirdfont').$thirdfontex."' rel='stylesheet' type='text/css'>"; } else { echo "<link href=\"http://fonts.googleapis.com/css?family=Noto+Sans\" rel=\"stylesheet\" type=\"text/css\">"; }
?>
<style type='text/css'>
    body {
        <?php
