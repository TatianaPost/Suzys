...
<?php } ?>
   <!--div--><!--strong <?php print $action_call_style; ?>> <?php print $action_call; ?></strong-->
	...
	<br><br><strong style='font-size:1.5em;'><img src='<?php print SL_IMAGES_BASE_ORIGINAL."/sl_twitter.jpg"; ?>'></strong>&nbsp;<input type='button' class='button-primary twitter_button' rel="<?php print $text; ?>+<?php print $url; ?>" value='Tell Others #1' />
