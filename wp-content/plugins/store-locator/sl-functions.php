...
<div id='sl_div'>
  <form onsubmit='searchLocations(); return false;' id='searchForm' action=''>
    <div style='float: left; width: 33%;'>$search_label <input type='text' id='addressInput' style='width: 9em;' /></div>
    <div style='float: left; width: 33%; text-align: middle;'>" . $sl_vars['radius_label'] . " <select id='radiusSelect'>$r_options</select></div>
    <div style='float: left; width: 33%;'><input $button_style value='Search Locations' id='addressSubmit'/></div>
...
// $form.="
// <div style='float: left; width: 48%;' id='map_td'>
//   <div id='sl_map' style='width:$width$width_units; height:$height$height_units'></div>
// </div>
...
// ";
$form.="
<table style='width:100%;/*border:solid silver 1px*/' cellspacing='0px' cellpadding='0px'>
  <tr>
    <td id='map_td'>
      <div id='sl_map' style='width:$width$width_units; height:$height$height_units'></div>
    </td>
  ...
  <tr id='cm_mapTR'>
    <td id='map_sidebar_td'>
      <div id='map_sidebar' style='width:$width$width_units;/* $height$height_units; */'>
        <div class='text_below_map'>$sl_instruction_message</div>
      </div>
    </tr>
  </tr>
